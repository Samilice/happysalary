        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal>
            <div className="max-w-xl">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-secondary">
                {t("title")}
              </h1>
          ...
          <ScrollReveal delay={200}>
            <div className="relative hidden lg:flex items-center justify-center">
              <div className="relative w-full max-w-md xl:max-w-lg mx-auto">
                ...
                {/* Floating cards */}
                <div className="absolute -top-3 -right-3 bg-white rounded-xl shadow-lg p-3 z-10">
                ...
                <div className="absolute -bottom-3 -left-3 bg-white rounded-xl shadow-lg p-3 z-10">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
                      <span className="text-xs font-bold text-primary">CHF</span>
                    </div>
                    <div>
                      <p className="text-xs font-bold">CHF 9.90/mois</p>
                      <p className="text-[10px] text-text-muted">Prix fixe</p>
                    </div>
                  </div>
                </div>
              </div>
