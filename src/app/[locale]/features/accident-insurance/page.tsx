...
const relatedFeatures = [
  { href: "/features/social-contributions", key: "socialContributions" },
  { href: "/features/employment-contracts", key: "employmentContracts" },
...
export default async function AccidentInsurancePage({ params }: Props) {
  ...
  const t = await getTranslations("features.accidentInsurance");
