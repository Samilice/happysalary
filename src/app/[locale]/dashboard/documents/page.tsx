...
const statusLabels: Record<string, { label: string; className: string }> = {
  ...
  generating: { label: "Génération...", className: "text-blue-600 bg-blue-50" },
  ready: { label: "Prêt", className: "text-success bg-success/10" },
  sent: { label: "Envoyé", className: "text-primary bg-primary/10" },
};
  ...
  return (
    <Container>
      <div className="max-w-5xl mx-auto">
        <h1 className="text-2xl font-bold text-secondary mb-6">Documents</h1>
        ...
        {documents && documents.length > 0 ? (
          ...
          <Card hover={false} className="text-center py-16">
            ...
            <h3 className="text-lg font-bold text-secondary mb-2">Aucun document</h3>
            <p className="text-sm text-text-muted max-w-sm mx-auto">
              Vos fiches de salaire et contrats de travail apparaîtront ici dès qu&apos;ils seront générés.
            </p>
          </Card>
        )}
      </div>
