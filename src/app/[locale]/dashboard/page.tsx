      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <Card hover={false} className="text-center p-4">
            ...
            <p className="text-xs text-text-muted mt-1">Employé(s) actif(s)</p>
          </Card>
          <Card hover={false} className="text-center p-4">
          ...
          <Card hover={false} className="text-center p-4">
            ...
            <p className="text-xs text-text-muted mt-1">Plan actuel</p>
          </Card>
          <Card hover={false} className="text-center p-4">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <Card hover={false}>
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-bold text-secondary">Mes employés</h2>
            ...
            {employees && employees.length > 0 ? (
              ...
              <p className="text-sm text-text-muted">Aucun employé pour le moment.</p>
            )}
          </Card>
          ...
          <Card hover={false}>
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-bold text-secondary">Documents récents</h2>
            ...
            {documents && documents.length > 0 ? (
                  ...
                  <div key={doc.id} className="flex items-center justify-between p-3 rounded-xl bg-background-alt">
                    <div>
                      ...
                      <p className="text-xs text-text-muted">
                        {doc.type === "salary_sheet" ? "Fiche de salaire" : doc.type === "employment_contract" ? "Contrat" : doc.type}
                      </p>
                    </div>
                    <span className={`text-xs font-medium px-2 py-1 rounded-full ${
                      ...
                      {doc.status === "ready" ? "Prêt" : doc.status === "pending" ? "En attente" : doc.status === "generating" ? "Génération..." : doc.status}
                    </span>
                  </div>
                ))}
              </div>
              ...
              <div className="text-center py-6">
                ...
                <p className="text-sm text-text-muted">Vos documents apparaîtront ici.</p>
              </div>
            )}
          </Card>
        </div>
